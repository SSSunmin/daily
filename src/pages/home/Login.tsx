    ...
    return (
        <div className={`w-[280px] py-[32px] flex flex-col justify-center align-center rounded-[24px] bg-white border border-[#E6E6E6]`}>
            <div className={`flex justify-center flex-col gap-[10px] px-[15px] py-[20px]`}>
                ...
                <button className={'flex justify-center items-center w-full h-[50px] bg-[#2BC09D] text-white font-bold rounded-[50px]'} >
                ...
                <p className={'text-center text-[#A9A9B2] text-[16px] font-semibold cursor-pointer'}>회원가입</p>
            </div>
        </div>
    );
};
